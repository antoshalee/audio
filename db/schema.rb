...
ActiveRecord::Schema.define(version: 20140319170221) do
  ...
  add_index "favorites", ["speaker_id"], name: "index_favorites_on_speaker_id", using: :btree
  ...
  create_table "speakers", force: true do |t|
    ...
    t.datetime "online_next_refresh"
  end

  add_index "speakers", ["online_next_refresh"], name: "index_speakers_on_online_next_refresh", using: :btree
